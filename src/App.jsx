...
export default function Bizora() {
  ...
  useEffect(() => {
    ...
    saveTimer.current = setTimeout(async () => {
      const payload = { theme, notifyLowStock, notifyPush, products, customers, sales, expenses, invoices };
      try {
  ...
  }, [loaded, authUser?.email, sbUserId, sbToken, theme, notifyLowStock, notifyPush, products, customers, sales, expenses, invoices]);
