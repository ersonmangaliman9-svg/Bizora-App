      ...
      <button onClick={poke} title="Kumusta! Tap me 👋" style={{ background: "none", border: "none", padding: 0, cursor: "pointer", flexShrink: 0, lineHeight: 0 }}>
        <div key={wave} style={{ animation: wave ? "bzMascotBounce .7s cubic-bezier(.34,1.56,.64,1)" : "none" }}>
          <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="mascotGrad" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#14876F" />
                <stop offset="1" stopColor="#0A5548" />
              </linearGradient>
            </defs>
            ...
            <path d="M77 56 Q91 49 87 35" stroke="#14876F" strokeWidth="7.5" strokeLinecap="round" fill="none"
                  style={{ transformOrigin: "77px 56px", animation: wave ? "bzMascotWave .7s ease" : "none" }} />
            <circle cx="50" cy="52" r="33" fill="url(#mascotGrad)" stroke="#0A5548" strokeWidth="2" />
