...
export default function Bizora() {
  ...
  useEffect(() => {
    ...
    saveTimer.current = setTimeout(async () => {
      const payload = { theme, notifyLowStock, products, customers, sales, expenses, invoices };
      try {
  ...
  }, [loaded, authUser?.email, sbUserId, sbToken, theme, notifyLowStock, products, customers, sales, expenses, invoices]);
